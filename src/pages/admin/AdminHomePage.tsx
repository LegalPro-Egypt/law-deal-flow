          ...
          <CardContent className="p-4 md:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl md:text-3xl font-bold text-primary">{stats.pendingReviews + stats.pendingVerifications + stats.pendingProposals + stats.pendingContracts}</p>
                <p className="text-xs text-muted-foreground mt-1">
                  {stats.pendingReviews} cases • {stats.pendingVerifications} verifications • {stats.pendingProposals} proposals • {stats.pendingContracts} contracts
                </p>
              </div>
