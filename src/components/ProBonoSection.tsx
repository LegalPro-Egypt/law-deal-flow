      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Vision Badge */}
            <div className={`flex justify-center ${isRTL() ? 'lg:justify-center' : 'lg:justify-start'} mb-6`}>
              <Badge 
                variant="secondary" 
            ...
            <div className={`grid lg:grid-cols-2 gap-8 items-center ${isRTL() ? 'lg:grid-cols-[1fr,auto]' : ''}`}>
              ...
              <div className={`text-center ${isRTL() ? 'lg:order-2 lg:text-right' : 'lg:order-1 lg:text-left'}`}>
                ...
                <div className={`flex justify-center ${isRTL() ? 'lg:justify-center' : 'lg:justify-start'}`}>
